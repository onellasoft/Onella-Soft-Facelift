...
const createInfiniteItems = (originalItems: CarouselItem[]) => {
  const items: (CarouselItem & { originalIndex: number, id: string })[] = [];
  for (let i = 0; i < 3; i++) {
...
export function RulerCarousel({
  ...
  const centerIndexOffset = (activeIndex % itemsPerSet);
  const targetX = (itemsPerSet / 2 - 0.5 - centerIndexOffset) * 500;
  ...
  return (
    <div className="w-full py-16 md:py-24 flex flex-col items-center justify-center bg-background dark:bg-black">
